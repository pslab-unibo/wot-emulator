...
import { Resolver } from "@thingweb/thing-model";
import { Thing, ThingInteraction } from "./thing-description";
...
export default class Helpers implements Resolver {
    ...
    static validateInteractionOptions(thing: Thing, ti: ThingInteraction, options?: WoT.InteractionOptions): boolean;
