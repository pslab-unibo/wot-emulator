...
class Servient {
    ...
    addCredentials(credentials) {
        var _a;
        for (const [credentialKey, credentialValue] of Object.entries(credentials !== null && credentials !== void 0 ? credentials : {})) {
            debug(`Servient storing credentials for '${credentialKey}'`);
            const currentCredentials = (_a = this.credentialStore.get(credentialKey)) !== null && _a !== void 0 ? _a : [];
