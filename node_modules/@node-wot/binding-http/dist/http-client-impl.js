...
class HttpClient {
    ...
    readResource(form) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = yield this.generateFetchRequest(form, "GET", { headers });
    ...
    invokeResource(form, content) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_a = form.response) === null || _a === void 0 ? void 0 : _a.contentType) != null) {
                headers.push(["accept", (_b = form.response) === null || _b === void 0 ? void 0 : _b.contentType]);
            }
            ...
            this.checkFetchResponse(result);
            const body = core_1.ProtocolHelpers.toNodeStream(result.body);
            return new core_1.Content((_c = result.headers.get("content-type")) !== null && _c !== void 0 ? _c : core_1.ContentSerdes.DEFAULT, body);
        });
    }
    unlinkResource(form) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    requestThingDescription(uri) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = yield this.generateFetchRequest({ href: uri }, "GET", headers);
